...
class DocumentExtractionEngine:
    ...
    def extract_fields(
        self, document_type: str, model_response: str
    ...
    def get_document_type_info(self, document_type: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "supported_field_types": list(
                set(p.field_type for p in handler.get_field_patterns())
            ),
        }

    def process_document(self, ocr_text: str, model_response: str) -> Dict[str, Any]:
        ...
        if classification.document_type != "unknown":
            extraction = self.extract_fields(
                classification.document_type, model_response
            )
